        ...
        <div>
            <a href="{{ route('contacts.index') }}"
               ...
               class="text-sm text-primary-600 hover:underline dark:text-primary-400">
                &larr; Zurück zu den Ansprechpartnern
            </a>

            <h1 class="mt-2 text-xl font-semibold text-gray-900 dark:text-gray-100">Ansprechpartnerrollen</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Rollen sind frei definierbar und können je Kundenzuordnung mehrfach vergeben werden.
            </p>
        </div>
