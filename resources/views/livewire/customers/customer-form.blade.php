<div>
    <x-page title="{{ $this->isEditing() ? 'Kunde bearbeiten' : 'Kunde anlegen' }}"
            subtitle="{{ $this->isEditing() ? 'Kundennummer '.$customer->customer_number.' — nach der Erstellung unveränderlich.' : 'Firmen- und Privatkunden unterscheiden sich in den Pflichtfeldern.' }}"
