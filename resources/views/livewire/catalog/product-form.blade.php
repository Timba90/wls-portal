<div>
    <div class="mb-6">
        <a href="{{ $this->isEditing() ? route('products.show', $product) : route('products.index') }}"
           wire:navigate
        ...
        <h1 class="mt-2 text-xl font-semibold text-gray-900 dark:text-gray-100">
            {{ $this->isEditing() ? 'Artikel bearbeiten' : 'Artikel anlegen' }}
        </h1>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <x-card>
            <x-slot:header>
                <h2 class="text-sm font-semibold text-gray-800 dark:text-gray-100">Standardpreise und Abrechnung</h2>
            </x-slot:header>
