<div>
    <x-page title="{{ $product->name }}"
        ...
        <x-slot:actions>
            <x-button sm color="secondary" outline icon="pencil" :href="route('products.edit', $product)" wire:navigate>
            Bearbeiten
                </x-button>
        ...
        <x-tab wire:model="tab">
            <x-tab.items tab="uebersicht" title="Übersicht">
                <div class="grid gap-4 lg:grid-cols-2">
                    ...
                    <x-card>
                        <x-slot:header>
                            <h2 class="text-sm font-semibold text-ink">Standardpreise</h2>
                        </x-slot:header>
